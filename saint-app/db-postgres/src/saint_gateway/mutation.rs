...
pub(crate) async fn update_gender(
    transaction: &Transaction<'_>,
    id: Uuid,
    is_male: bool,
) -> Result<u64, Error> {
...
pub(crate) async fn delete_id(transaction: &Transaction<'_>, id: Uuid) -> Result<u64, Error> {
...
pub(crate) async fn delete_gender(transaction: &Transaction<'_>, id: Uuid) -> Result<u64, Error> {
    let stmt = (*transaction)
...
pub(crate) async fn delete_feast_day(
    transaction: &Transaction<'_>,
    id: Uuid,
) -> Result<u64, Error> {
    let stmt = (*transaction)
